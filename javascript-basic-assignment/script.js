...
function question2() {
  ...
  // to check blank space
  var isBlank = /^\s*$/.test(inputString);
  if (isBlank == true) {
    resultFromHtml.innerText = "Enter the Correct Input String";
    resultFromHtml.style.color = "red";
  } else {
...
function question6() {
  ...
  var isBlank = /^\s*$/.test(finalAns);
  if (isBlank == true) {
    answersetter.innerText = "Enter the Correct Input String";
    answersetter.style.color = "red";
  } else {
